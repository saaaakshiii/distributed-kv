...
var file_kvStore_proto_goTypes = []any{
	...
	(*KeyValuePair)(nil), // 3: kvStore.KeyValuePair
...
var file_kvStore_proto_depIdxs = []int32{
	...
	4, // 4: kvStore.kvstore.kv_get:output_type -> kvStore.opGetRes
	2, // 5: kvStore.kvstore.kv_set:output_type -> kvStore.opRes
	2, // 6: kvStore.kvstore.kv_del:output_type -> kvStore.opRes
